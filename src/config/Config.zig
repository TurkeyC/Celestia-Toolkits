...
pub const KeyMap = struct {
    next: vaxis.Key = .{ .codepoint = vaxis.Key.right },
    prev: vaxis.Key = .{ .codepoint = vaxis.Key.left },
    ...
    zoom_in: vaxis.Key = .{ .codepoint = '=' },
    zoom_in_mult: vaxis.Key = .{ .codepoint = '=', .mods = .{ .shift = true } },
    zoom_out: vaxis.Key = .{ .codepoint = '-' },
    zoom_out_mult: vaxis.Key = .{ .codepoint = '-', .mods = .{ .shift = true } },
